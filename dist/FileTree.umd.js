(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('sl-vue-tree'), require('@fortawesome/fontawesome-svg-core'), require('@fortawesome/vue-fontawesome'), require('@fortawesome/free-solid-svg-icons')) :
  typeof define === 'function' && define.amd ? define(['exports', 'sl-vue-tree', '@fortawesome/fontawesome-svg-core', '@fortawesome/vue-fontawesome', '@fortawesome/free-solid-svg-icons'], factory) :
  (global = global || self, factory(global.FileTree = {}, global['sl-vue-tree'], global['@fortawesome/fontawesome-svg-core'], global['@fortawesome/vue-fontawesome'], global['@fortawesome/free-solid-svg-icons']));
}(this, function (exports, SlVueTree, fontawesomeSvgCore, vueFontawesome, freeSolidSvgIcons) { 'use strict';
